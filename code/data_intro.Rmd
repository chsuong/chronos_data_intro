...
library(sjPlot) #For creating Word-compatible tables from pglm models
library(sjmisc) #For creating Word-compatible tables from pglm models
...
tab_model(m_rep_m, m_rep_a,m_rep_m2, m_rep_app, m_vis1, m_evt,  
        #labelDependentVariables=labdep,
        #labelPredictors=lab,
        file="pglm.table.html",
        pvaluesAsNumbers=T,
