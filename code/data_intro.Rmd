...
#Cable traffic by state, excluding 0 cables by some countries that did not exist in the 1970s. Note that this does include the cables tagged with US. 
cable_n_states_70s<-
  country_tag_doc2 %>%
  group_by(cow_ccode, cow_statename, cow_stateabb) %>%
  tally() %>%
...
##Summary statistics of cable traffic by country-year and by country
```{r}
setwd("/Users/clarahsuong/chronos_data_intro")
...
stargazer(as.data.frame(cable_n_all_states_year)[c("year", "cow_ccode", "n_c_y")], 
          type = "text", 
          title="Summary Statistics of Cable Traffic by Country-Year (Incl. Former Countries)", 
          digits=1, 
...
stargazer(as.data.frame(cable_n_states_70s_year[cable_n_states_70s_year$cow_ccode!=2,])[c("year", "cow_ccode", "n_c_y")], 
          type = "text", 
          title="Summary Statistics of Cable Traffic by Country-Year (Only Existing Non-U.S. Countries)", 
          digits=1, 
...
stargazer(as.data.frame(cable_n_all_states)[c("cow_ccode", "n_c")], 
          type = "text", 
          title="Summary Statistics of Cable Traffic by Country (Incl. Former Countries)", 
          digits=1, 
          out="./data_analysis_output/desc_cable_n_all_states.txt",
          covariate.labels=c("COW Codes of Countries Tagged in Cables", "Cable Traffic for Each Country"))
...
stargazer(as.data.frame(cable_n_states_70s)[c("cow_ccode", "n_c")], 
          type = "text", 
          title="Summary Statistics of Cable Traffic by Country (Incl. Only Existing Countries)", 
          digits=1, 
...
stargazer(as.data.frame(cable_n_states_70s[cable_n_states_70s$cow_ccode!=2,])[c("cow_ccode", "n_c")], 
          type = "text", 
          title="Summary Statistics of Cable Traffic by Country (Incl. Only Existing Non-U.S. Countries)", 
          digits=1, 
...
#The distribution for the count variables is zero-inflated. Convert the raw number of cables to a 0-1 index???  
...
hist(cable_n_states_70s_year[cable_n_states_70s_year$cow_ccode!=2,]$n_c_y, # histogram
 ...
 ylim = c(0, 0.0004),
 xlab = "Number of Cables Tagged",
 main = "Existing Non-U.S. Country-Years")
...
hist(cable_n_states_70s[cable_n_states_70s$cow_ccode!=2,]$n_c, # histogram
 ...
 #xlim = c(0, 20000), 
  ylim = c(0, 0.0004),
 xlab = "Number of Cables",
 main = "Existing Non-U.S. Countries")
...
stargazer(table_state_year_bottom20[c("year", "cow_statename", "n_c_y","rel.freq")],
          summary = FALSE,
          rownames = FALSE,
          type = "text", 
          title="Non-U.S. Country-Years with Fewest Cables", 
          digits=1, 
          out="./data_analysis_output/bottom20_cable_n_state_year.txt",
          covariate.labels=c("Year","Tagged Country", "Number of Cables", "Relative Frequency"))
...
stargazer(table_state_year_bottom20[c("year", "cow_statename", "n_c_y","rel.freq")],
          ...
          title="Non-U.S. Country-Years with Fewest Cables", 
          digits=1, 
          out="./data_analysis_output/bottom20_cable_n_state_year.html",
          covariate.labels=c("Year","Tagged Country", "Number of Cables", "Relative Frequency"))
```
...
#  ungroup %>%
  mutate(#total_n_c= sum(n_c), 
         rel.freq = paste0(round(100 * n_c/total_n, 0), "%")) %>%
  arrange(desc(n_c)) %>%
  top_n(n = -20, wt = n_c) 

stargazer(table_state_bottom20[c("cow_statename", "n_c","rel.freq")],
          summary = FALSE,
          rownames = FALSE,
          type = "text", 
          title="Non-U.S. Countries Least Frequently Tagged in Cables", 
          digits=1, 
          out="./data_analysis_output/bottom20_cable_n_state.txt",
          covariate.labels=c("Country", "Number of Cables", "Relative Frequency"))
...
stargazer(table_state_bottom20[c("cow_statename", "n_c","rel.freq")],
          ...
          title="Non-U.S. Countries Least Frequently Tagged in Cables", 
          digits=1, 
          out="./data_analysis_output/bottom20_cable_n_state.html",
          covariate.labels=c("Country", "Number of Cables", "Relative Frequency"))
```
