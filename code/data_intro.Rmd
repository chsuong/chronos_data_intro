...
countries<-
  tbl(mydb, 'countries') %>% 
  collect() #Note that there is no tag for "South Vietnam" but tag "VM" (id: 557) for "Vietnam" according to this table. The 1976 TAGS manual lists VN (tag id 1976) for "Viet-Nam (North)"and VS (tag id 1973) for "Viet-Nam (South)". There is also no tag for Serbia and Montenegro. 
