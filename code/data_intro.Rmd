...
stargazer(as.data.frame(cable_n_states_70s_year[cable_n_states_70s_year$cow_ccode!=2,])[c("year", "cow_ccode", "n_c_y")], 
          type = "text", 
          title="Summary Statistics of Tag Traffic by Country-Year (Only Existing Non-U.S. Countries)", 
          digits=1, 
...
stargazer(as.data.frame(cable_n_states_70s[cable_n_states_70s$cow_ccode!=2,])[c("cow_ccode", "n_c")], 
          type = "text", 
          title="Summary Statistics of Tag Traffic by Country (Incl. Only Existing Non-U.S. Countries)", 
          digits=1, 
...
us_dip_c_y<-
  ...
  left_join(us_dip_rep_app, by=c("year", "cow_ccode")) %>%
  left_join(us_dip_vis, by=c("year", "cow_ccode")) %>%
  left_join(us_dip_evt, by=c("year", "cow_ccode")) %>%
...
#Compare the yearly tag traffic with the country-year data on diplomatic visits
