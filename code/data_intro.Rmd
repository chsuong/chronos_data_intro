...
states_70s<-
  ...
  #filter(year>1972 & year<1980) %>%
  #left_join(all_states, by="cow_ccode") %>%#Attach COW state names and abbreviations
  #distinct()
```
...
save(cable_n_all_country_year, file = "/Users/clarahsuong/chronos_data_intro/data/cable_n_all_country_year.RData")
#load("./data/cable_n_all_country_year.RData")

#Cable traffic by country, including 0 cables by some countries that have ever existed. Note that this does include the cables tagged with US. 
cable_n_all_states<-
  country_tag_doc2 %>%
