...
setwd(dirname(getwd()))
getwd()
#setwd("/Users/clarahsuong/Dropbox/nyu_postdoc/ner/dataset_intro") #If necessary, set as the working directory a location where you can save large data files with file size over 100mb (github limitation).
...
stargazer(as.data.frame(cable_n_vis_country_y), 
          ...
          digits=1, 
          out="../data_analysis_output/desc_cable_n_vis_country_year.html"#,
