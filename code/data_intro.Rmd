...
DF<-us_dip_c_y[c("n_c_y","dip_focus","dip_rep_m",
                                     #"dip_rep_a",
                                     "politicalappointee_year","performanceMU_year",
...
glm.nb_politicalappointee <- MASS::glm.nb(n_c_y~politicalappointee_year, data = us_dip_c_y)
...
coef_test(fixed_m_rep_a, vcov = "CR1", cluster = "individual", test = "naive-t")
