...
```{r,results='hide', message=FALSE, warning=FALSE}
us_dip_rep_moyer<-
  read_csv("../external_data/moyeretal_2016/Pardee Center Diplomatic Representation_COW 20190208.csv", locale = locale(encoding = "UTF-8")) %>% #COW-compatible version
