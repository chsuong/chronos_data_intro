...
#Yearly cable traffic by country-year
...
stargazer(as.data.frame(cable_n_country_date), 
          type = "html", 
          title="Summary Statistics of Daily Cable Traffic", 
          digits=1, 
          out="../data_analysis_output/desc_cable_n_country_day.html"#,
...
us_dip_rep_app <-  
  ...
  filter(year>1969 & year<1981) %>%
  dplyr::select(year, ccode, country_ambassador, position, ambassador, politicalappointee,performanceMU,good, bad) %>%
